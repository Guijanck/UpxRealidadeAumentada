        ...
        <View style={styles.coursesContainer}>
          ...
          <View style={styles.courseCard}>
            <View style={styles.courseImageContainer}>
              <Image
                source={{
                  uri: 'https://ichef.bbci.co.uk/ace/ws/640/cpsprodpb/164EE/production/_109347319_gettyimages-611195980.jpg.webp',
                }}
                style={styles.courseImage}
              />
            </View>
            <View style={styles.courseInfo}>
              <Text style={styles.courseTitle}>Matemática e Suas Tecnologias</Text>
              <Text style={styles.courseSubtitle}>6º Ano - 1º e 2º Bimestre</Text>
              <Text style={styles.courseTeacher}>Prof. Mauro Abreu</Text>
              <Text style={styles.courseProgress}>9/26</Text>
          ...
          <View style={styles.courseCard}>
            <View style={styles.courseImageContainer}>
              <Image
                source={{
                  uri: 'https://static.ndmais.com.br/2023/11/istock-1175038196-800x566.jpg',
                }}
                style={styles.courseImage}
              />
            </View>
            <View style={styles.courseInfo}>
              <Text style={styles.courseTitle}>Língua Portuguesa</Text>
              <Text style={styles.courseSubtitle}>6º Ano - 1º e 2º Bimestre</Text>
              <Text style={styles.courseTeacher}>Prof. Rafael Cruz</Text>
              <Text style={styles.courseProgress}>12/15</Text>
              <View style={styles.progressBar}>
